...
:: Android packaging
set AND_CERT_NAME="maptestios"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\maptestios.p12
...
set IOS_PROVISION=cert\maptestios.mobileprovision
...
set APP_ID=air.maptestios

:: Output packages
set DIST_PATH=dist
set DIST_NAME=maptestios
